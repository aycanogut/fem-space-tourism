          ...
          <ul className="mr-auto flex flex-col gap-9 pt-14 sm:ml-auto sm:flex-row sm:pt-0 lg:ml-nav_lg_left lg:mr-auto lg:gap-12">
            {navigation?.map((item: IHeaderItems) => (
              <Link key={item.url} href={item.url} passHref>
                <a>
                  <li className="mt-[2px] flex gap-3 font-barlow text-16 uppercase tracking-normal text-white transition-all hover:border-b-2 hover:border-white active:border-b-2 active:border-white sm:pb-[38px] sm:text-14 md:pb-[35px] lg:gap-nav_lg_gap lg:text-16">
